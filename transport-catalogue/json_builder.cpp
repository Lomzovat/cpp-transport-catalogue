...
namespace json {
    namespace builder {
        ...
        Node Builder::CreateNode(const Node::Value& value_) {
            Node node;
            ...
            if (std::holds_alternative<bool>(value_)) {
                ...
                int int_val = std::get<int>(value_);
                node = Node(int_val);

            }
            else if (std::holds_alternative<double>(value_)) {
                double double_val = std::get<double>(value_);
                node = Node(double_val);
        ...
        void Builder::AddNode(const Node& node) {
            if (nodes_stack_.empty()) {
                ...
                if (!root_.IsNull()) {
                    throw std::logic_error("root was added");
                }
